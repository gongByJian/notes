...
- [Spring docs](https://docs.spring.io/spring-framework/docs/current/spring-framework-reference/core.html#spring-core)

- [Groovy](http://www.groovy-lang.org/)

- [mybatis](http://www.mybatis.org/mybatis-3/index.html)

- [spring boot 自动生成依赖](http://start.spring.io/)

- [elastic](http://www.elastic.co/cn/products)
